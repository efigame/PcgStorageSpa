...
--
-- Table structure for table `allycard`
--

DROP TABLE IF EXISTS `allycard`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `allycard` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `Name` varchar(100) NOT NULL,
  `AdventureDeckId` int(11) NOT NULL,
  PRIMARY KEY (`Id`),
  KEY `fk_allycard_adventuredeck_idx` (`AdventureDeckId`),
  CONSTRAINT `fk_allycard_adventuredeck` FOREIGN KEY (`AdventureDeckId`) REFERENCES `adventuredeck` (`Id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=43 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `allycard`
--

LOCK TABLES `allycard` WRITE;
/*!40000 ALTER TABLE `allycard` DISABLE KEYS */;
INSERT INTO `allycard` VALUES (1,'Acolyte',1),(2,'Archer',1),(3,'Burglar',1),(4,'Crow',1),(5,'Father Zantus',1),(6,'Guard',1),(7,'Guide',1),(8,'Mayor Kendra Deverin',1),(9,'Night Watch',1),(10,'Sage',1),(11,'Shalelu Andosana',1),(12,'Sheriff Hemlock',1),(13,'Soldier',1),(14,'Standard Bearer',1),(15,'Troubadour',1),(16,'Dog',2),(17,'Saber-Toothed Tiger',2),(18,'Snake',2),(19,'Aldern Foxglove',3),(20,'Ameik Kaijitsu',3),(21,'Cyrdak Drokkus',3),(22,'Grizzled Mercenary',3),(23,'Ilsoari Gandethus',3),(24,'Toad',3),(25,'Ven Vinder',3),(26,'Brodert Quink',4),(27,'Maester Grump',4),(28,'Merchant',4),(29,'Black Arrow Ranger',5),(30,'Cat',5),(31,'Giant Badger',5),(32,'Jakardos Sovark',5),(33,'Monkey',5),(34,'Vale Temros',5),(35,'Yap the Pixie',5),(36,'Bear',6),(37,'Charmed Red Dragon',6),(38,'Clockwork Librarian',6),(39,'Conna the Wise',6),(40,'Eagle',6),(41,'Lizard',6);
/*!40000 ALTER TABLE `allycard` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `armorcard`
--

DROP TABLE IF EXISTS `armorcard`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `armorcard` (
  ...
  `AdventureDeckId` int(11) NOT NULL,
  PRIMARY KEY (`Id`),
  KEY `fk_armorcard_adventuredeck_idx` (`AdventureDeckId`),
  CONSTRAINT `fk_armorcard_adventuredeck` FOREIGN KEY (`AdventureDeckId`) REFERENCES `adventuredeck` (`Id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=36 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `armorcard`
--

LOCK TABLES `armorcard` WRITE;
/*!40000 ALTER TABLE `armorcard` DISABLE KEYS */;
INSERT INTO `armorcard` VALUES (1,'Chain Mail',1),(2,'Elven Chain Shirt',1),(3,'Half-Plate',1),(4,'Leather Armor',1),(5,'Magic Chain Mail',1),(6,'Magic Half-Plate',1),(7,'Magic Leather Armor',1),(8,'Magic Shield',1),(9,'Wooden Shield',1),(16,'Elven Breastplate',3),(17,'Shield of Fire Resistance',3),(19,'Arrow Catching Studded Leather',4),(20,'Deathbane Shield',4),(21,'Hide Armor of Fire Resistance',4),(22,'Snakeskin Tunic',4),(26,'Magic Full Plate',5),(27,'Magic Studded Leather Armor',5),(28,'Spiny Shield',5),(29,'Breastplate of Fire Resistance',6),(30,'Chainmail of Cold Resistance',6),(31,'Lesser Bolstering Armor',6),(32,'Reflecting Shield',6);
/*!40000 ALTER TABLE `armorcard` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `barriercard`
--

DROP TABLE IF EXISTS `barriercard`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `barriercard` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `Name` varchar(100) NOT NULL,
  `AdventureDeckId` int(11) NOT NULL,
  PRIMARY KEY (`Id`),
  KEY `fk_barriercard_adventuredeck_idx` (`AdventureDeckId`),
  CONSTRAINT `fk_barriercard_adventuredeck` FOREIGN KEY (`AdventureDeckId`) REFERENCES `adventuredeck` (`Id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `barriercard`
--

LOCK TABLES `barriercard` WRITE;
/*!40000 ALTER TABLE `barriercard` DISABLE KEYS */;
/*!40000 ALTER TABLE `barriercard` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `blessingcard`
--

DROP TABLE IF EXISTS `blessingcard`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `blessingcard` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `Name` varchar(100) NOT NULL,
  `AdventureDeckId` int(11) NOT NULL,
  PRIMARY KEY (`Id`),
  KEY `fk_blessingcard_adventuredeck_idx` (`AdventureDeckId`),
  CONSTRAINT `fk_blessingcard_adventuredeck` FOREIGN KEY (`AdventureDeckId`) REFERENCES `adventuredeck` (`Id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `blessingcard`
--

LOCK TABLES `blessingcard` WRITE;
/*!40000 ALTER TABLE `blessingcard` DISABLE KEYS */;
INSERT INTO `blessingcard` VALUES (1,'Blessing of Calistria',1),(2,'Blessing of Desna',1),(3,'Blessing of Erastil',1),(4,'Blessing of Gorum',1),(5,'Blessing of Iomedae',1),(6,'Blessing of Irori',1),(7,'Blessing of Pharasma',1),(8,'Blessing of Sarenrae',1),(9,'Blessing of Shelyn',1),(10,'Blessing of the Gods',1),(11,'Blessing of Torag',1),(16,'Blessing of Lamashtu',3),(17,'Blessing of Abadar',4),(18,'Blessing of Norgorber',5),(19,'Blessing of Gorzreh',6);
/*!40000 ALTER TABLE `blessingcard` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `characterallycard`
--

DROP TABLE IF EXISTS `characterallycard`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `characterallycard` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `CharacterId` int(11) NOT NULL,
  `AllyCardId` int(11) NOT NULL,
  `Count` int(11) NOT NULL,
  PRIMARY KEY (`Id`),
  KEY `fk_characterallycard_character_idx` (`CharacterId`),
  KEY `fk_characterallycard_allycard_idx` (`AllyCardId`),
  CONSTRAINT `fk_characterallycard_character` FOREIGN KEY (`CharacterId`) REFERENCES `character` (`Id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_characterallycard_allycard` FOREIGN KEY (`AllyCardId`) REFERENCES `allycard` (`Id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `characterallycard`
--

LOCK TABLES `characterallycard` WRITE;
/*!40000 ALTER TABLE `characterallycard` DISABLE KEYS */;
/*!40000 ALTER TABLE `characterallycard` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `characterarmorcard`
--

DROP TABLE IF EXISTS `characterarmorcard`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `characterarmorcard` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `CharacterId` int(11) NOT NULL,
  `ArmorCardId` int(11) NOT NULL,
  `Count` int(11) NOT NULL,
  PRIMARY KEY (`Id`),
  KEY `fk_characterarmorcard_character_idx` (`CharacterId`),
  KEY `fk_characterarmorcard_armorcard_idx` (`ArmorCardId`),
  CONSTRAINT `fk_characterarmorcard_character` FOREIGN KEY (`CharacterId`) REFERENCES `character` (`Id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_characterarmorcard_armorcard` FOREIGN KEY (`ArmorCardId`) REFERENCES `armorcard` (`Id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `characterarmorcard`
--

LOCK TABLES `characterarmorcard` WRITE;
/*!40000 ALTER TABLE `characterarmorcard` DISABLE KEYS */;
/*!40000 ALTER TABLE `characterarmorcard` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `characterblessingcard`
--

DROP TABLE IF EXISTS `characterblessingcard`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `characterblessingcard` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `CharacterId` int(11) NOT NULL,
  `BlessingCardId` int(11) NOT NULL,
  `Count` int(11) NOT NULL,
  PRIMARY KEY (`Id`),
  KEY `fk_characterblessingcard_character_idx` (`CharacterId`),
  KEY `fk_characterblessingcard_blessingcard_idx` (`BlessingCardId`),
  CONSTRAINT `fk_characterblessingcard_character` FOREIGN KEY (`CharacterId`) REFERENCES `character` (`Id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_characterblessingcard_blessingcard` FOREIGN KEY (`BlessingCardId`) REFERENCES `blessingcard` (`Id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `characterblessingcard`
--

LOCK TABLES `characterblessingcard` WRITE;
/*!40000 ALTER TABLE `characterblessingcard` DISABLE KEYS */;
/*!40000 ALTER TABLE `characterblessingcard` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `characteritemcard`
--

DROP TABLE IF EXISTS `characteritemcard`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `characteritemcard` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `CharacterId` int(11) NOT NULL,
  `ItemCardId` int(11) NOT NULL,
  `Count` int(11) NOT NULL,
  PRIMARY KEY (`Id`),
  KEY `fk_characteritemcard_character_idx` (`CharacterId`),
  KEY `fk_characteritemcard_itemcard_idx` (`ItemCardId`),
  CONSTRAINT `fk_characteritemcard_character` FOREIGN KEY (`CharacterId`) REFERENCES `character` (`Id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_characteritemcard_itemcard` FOREIGN KEY (`ItemCardId`) REFERENCES `itemcard` (`Id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `characteritemcard`
--

LOCK TABLES `characteritemcard` WRITE;
/*!40000 ALTER TABLE `characteritemcard` DISABLE KEYS */;
/*!40000 ALTER TABLE `characteritemcard` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `characterspellcard`
--

DROP TABLE IF EXISTS `characterspellcard`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `characterspellcard` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `CharacterId` int(11) NOT NULL,
  `SpellCardId` int(11) NOT NULL,
  `Count` int(11) NOT NULL,
  PRIMARY KEY (`Id`),
  KEY `fk_characterspellcard_character_idx` (`CharacterId`),
  KEY `fk_characterspellcard_spellcard_idx` (`SpellCardId`),
  CONSTRAINT `fk_characterspellcard_character` FOREIGN KEY (`CharacterId`) REFERENCES `character` (`Id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_characterspellcard_spellcard` FOREIGN KEY (`SpellCardId`) REFERENCES `spellcard` (`Id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `characterspellcard`
--

LOCK TABLES `characterspellcard` WRITE;
/*!40000 ALTER TABLE `characterspellcard` DISABLE KEYS */;
/*!40000 ALTER TABLE `characterspellcard` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `characterweaponcard`
--

DROP TABLE IF EXISTS `characterweaponcard`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `characterweaponcard` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `CharacterId` int(11) NOT NULL,
  `WeaponCardId` int(11) NOT NULL,
  `Count` int(11) NOT NULL,
  PRIMARY KEY (`Id`),
  KEY `fk_characterweaponcard_character_idx` (`CharacterId`),
  KEY `fk_characterweaponcard_weaponcard_idx` (`WeaponCardId`),
  CONSTRAINT `fk_characterweaponcard_character` FOREIGN KEY (`CharacterId`) REFERENCES `character` (`Id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_characterweaponcard_weaponcard` FOREIGN KEY (`WeaponCardId`) REFERENCES `weaponcard` (`Id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `characterweaponcard`
--

LOCK TABLES `characterweaponcard` WRITE;
/*!40000 ALTER TABLE `characterweaponcard` DISABLE KEYS */;
/*!40000 ALTER TABLE `characterweaponcard` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `henchmencard`
--

DROP TABLE IF EXISTS `henchmencard`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `henchmencard` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `Name` varchar(100) NOT NULL,
  `AdventureDeckId` int(11) NOT NULL,
  PRIMARY KEY (`Id`),
  KEY `fk_henchmencard_adventuredeck_idx` (`AdventureDeckId`),
  CONSTRAINT `fk_henchmencard_adventuredeck` FOREIGN KEY (`AdventureDeckId`) REFERENCES `adventuredeck` (`Id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `henchmencard`
--

LOCK TABLES `henchmencard` WRITE;
/*!40000 ALTER TABLE `henchmencard` DISABLE KEYS */;
/*!40000 ALTER TABLE `henchmencard` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `itemcard` (
  ...
  `AdventureDeckId` int(11) NOT NULL,
  PRIMARY KEY (`Id`),
  KEY `fk_itemcard_adventuredeck_idx` (`AdventureDeckId`),
  CONSTRAINT `fk_itemcard_adventuredeck` FOREIGN KEY (`AdventureDeckId`) REFERENCES `adventuredeck` (`Id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
LOCK TABLES `itemcard` WRITE;
/*!40000 ALTER TABLE `itemcard` DISABLE KEYS */;
INSERT INTO `itemcard` VALUES (1,'Amulet of Fortitude',1),(2,'Amulet of Life',1),(3,'Blast Stone',1),(4,'Boots of Elvenkind',1),(5,'Bracers of Protection',1),(6,'Caltrops',1),(7,'Cape of Escape',1),(8,'Codex',1),(9,'Crowbar',1),(10,'Holy Candle',1),(11,'Holy Water',1),(12,'Luckstone',1),(13,'Masterwork Tools',1),(14,'Mattock',1),(15,'Potion of Energy Resistance',1),(16,'Potion of Fortitude',1),(17,'Potion of Ghostly Form',1),(18,'Potion of Glibness',1),(19,'Potion of Healing',1),(20,'Potion of Hiding',1),(21,'Potion of Vision',1),(22,'Spyglass',1),(23,'Thieve\'s Tools',1),(24,'Token of Remembrance',1),(25,'Tome of Knowledge',1),(32,'Amulet of Mighty Fists',2),(33,'Crown of Charisma',2),(34,'Eyes of the Eagle',2),(35,'Sage\'s journal',2),(39,'Sihedron  Medallion',3),(40,'Potion of Gracefulness',3),(41,'Potion of Ruggedness',3),(42,'Staff of Minor Healing',3),(43,'Wand of Force Missile',3),(44,'Wand of Shield',3),(46,'Medusa Mask',4),(47,'Sihedron  Medallion',4),(48,'Chime of Unlocking',4),(49,'Cloak of Elvenkind',4),(50,'Ring of Protection',4),(53,'Belt of Giant Strength',5),(54,'Belt of Incredible Dexterity',5),(55,'Headband of Alluring Charisma',5),(56,'Wand of Scorching Ray',5),(60,'Amulet of Fiery Fists',6),(61,'Bracers of Greater Protection',6),(62,'Greater Luckstone',6),(63,'Headband of Inspired Wisdom',6),(64,'Magic Spyglass',6),(65,'Necklace of Fireballs',6),(66,'Staff of Heaven and Earth',6);
/*!40000 ALTER TABLE `itemcard` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `monstercard`
--
...
CREATE TABLE `monstercard` (
  ...
  `AdventureDeckId` int(11) NOT NULL,
  PRIMARY KEY (`Id`),
  KEY `fk_monstercard_adventuredeck_idx` (`AdventureDeckId`),
  CONSTRAINT `fk_monstercard_adventuredeck` FOREIGN KEY (`AdventureDeckId`) REFERENCES `adventuredeck` (`Id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `monstercard`
--

LOCK TABLES `monstercard` WRITE;
/*!40000 ALTER TABLE `monstercard` DISABLE KEYS */;
/*!40000 ALTER TABLE `monstercard` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `removedallycard`
--

DROP TABLE IF EXISTS `removedallycard`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `removedallycard` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `Count` int(11) NOT NULL,
  `PartyId` int(11) NOT NULL,
  `AllyCardId` int(11) NOT NULL,
  PRIMARY KEY (`Id`),
  KEY `fk_removedallycard_party_idx` (`PartyId`),
  KEY `fk_removedallycard_allycard_idx` (`AllyCardId`),
  CONSTRAINT `fk_removedallycard_party` FOREIGN KEY (`PartyId`) REFERENCES `party` (`Id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_removedallycard_allycard` FOREIGN KEY (`AllyCardId`) REFERENCES `allycard` (`Id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `removedallycard`
--

LOCK TABLES `removedallycard` WRITE;
/*!40000 ALTER TABLE `removedallycard` DISABLE KEYS */;
/*!40000 ALTER TABLE `removedallycard` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `removedarmorcard`
--

DROP TABLE IF EXISTS `removedarmorcard`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `removedarmorcard` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `Count` int(11) NOT NULL,
  `PartyId` int(11) NOT NULL,
  `ArmorCardId` int(11) NOT NULL,
  PRIMARY KEY (`Id`),
  KEY `fk_removedarmorcard_party_idx` (`PartyId`),
  KEY `fk_removedarmorcard_armorcard_idx` (`ArmorCardId`),
  CONSTRAINT `fk_removedarmorcard_party` FOREIGN KEY (`PartyId`) REFERENCES `party` (`Id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_removedarmorcard_armorcard` FOREIGN KEY (`ArmorCardId`) REFERENCES `armorcard` (`Id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `removedarmorcard`
--

LOCK TABLES `removedarmorcard` WRITE;
/*!40000 ALTER TABLE `removedarmorcard` DISABLE KEYS */;
/*!40000 ALTER TABLE `removedarmorcard` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `removedbarriercard`
--

DROP TABLE IF EXISTS `removedbarriercard`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `removedbarriercard` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `Count` int(11) NOT NULL,
  `PartyId` int(11) NOT NULL,
  `BarrierCardId` int(11) NOT NULL,
  PRIMARY KEY (`Id`),
  KEY `fk_removedbarriercard_party_idx` (`PartyId`),
  KEY `fk_removedbarriercard_barriercard_idx` (`BarrierCardId`),
  CONSTRAINT `fk_removedbarriercard_party` FOREIGN KEY (`PartyId`) REFERENCES `party` (`Id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_removedbarriercard_barriercard` FOREIGN KEY (`BarrierCardId`) REFERENCES `barriercard` (`Id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `removedbarriercard`
--

LOCK TABLES `removedbarriercard` WRITE;
/*!40000 ALTER TABLE `removedbarriercard` DISABLE KEYS */;
/*!40000 ALTER TABLE `removedbarriercard` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `removedblessingcard`
--

DROP TABLE IF EXISTS `removedblessingcard`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `removedblessingcard` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `Count` int(11) NOT NULL,
  `PartyId` int(11) NOT NULL,
  `BlessingCardId` int(11) NOT NULL,
  PRIMARY KEY (`Id`),
  KEY `fk_removedblessingcard_party_idx` (`PartyId`),
  KEY `fk_removedblessingcard_blessingcard_idx` (`BlessingCardId`),
  CONSTRAINT `fk_removedblessingcard_party` FOREIGN KEY (`PartyId`) REFERENCES `party` (`Id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_removedblessingcard_blessingcard` FOREIGN KEY (`BlessingCardId`) REFERENCES `blessingcard` (`Id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `removedblessingcard`
--

LOCK TABLES `removedblessingcard` WRITE;
/*!40000 ALTER TABLE `removedblessingcard` DISABLE KEYS */;
/*!40000 ALTER TABLE `removedblessingcard` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `removedhenchmencard`
--

DROP TABLE IF EXISTS `removedhenchmencard`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `removedhenchmencard` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `Count` int(11) NOT NULL,
  `PartyId` int(11) NOT NULL,
  `HenchmenCardId` int(11) NOT NULL,
  PRIMARY KEY (`Id`),
  KEY `fk_removedhenchmencard_party_idx` (`PartyId`),
  KEY `fk_removedhenchmencard_henchmencard_idx` (`HenchmenCardId`),
  CONSTRAINT `fk_removedhenchmencard_party` FOREIGN KEY (`PartyId`) REFERENCES `party` (`Id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_removedhenchmencard_henchmencard` FOREIGN KEY (`HenchmenCardId`) REFERENCES `henchmencard` (`Id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `removedhenchmencard`
--

LOCK TABLES `removedhenchmencard` WRITE;
/*!40000 ALTER TABLE `removedhenchmencard` DISABLE KEYS */;
/*!40000 ALTER TABLE `removedhenchmencard` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `removeditemcard`
--

DROP TABLE IF EXISTS `removeditemcard`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `removeditemcard` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `Count` int(11) NOT NULL,
  `PartyId` int(11) NOT NULL,
  `ItemCardId` int(11) NOT NULL,
  PRIMARY KEY (`Id`),
  KEY `fk_removeditemcard_party_idx` (`PartyId`),
  KEY `fk_removeditemcard_itemcard_idx` (`ItemCardId`),
  CONSTRAINT `fk_removeditemcard_party` FOREIGN KEY (`PartyId`) REFERENCES `party` (`Id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_removeditemcard_itemcard` FOREIGN KEY (`ItemCardId`) REFERENCES `itemcard` (`Id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `removeditemcard`
--

LOCK TABLES `removeditemcard` WRITE;
/*!40000 ALTER TABLE `removeditemcard` DISABLE KEYS */;
/*!40000 ALTER TABLE `removeditemcard` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `removedmonstercard`
--

DROP TABLE IF EXISTS `removedmonstercard`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `removedmonstercard` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `Count` int(11) NOT NULL,
  `PartyId` int(11) NOT NULL,
  `MonsterCardId` int(11) NOT NULL,
  PRIMARY KEY (`Id`),
  KEY `fk_removedmonstercard_party_idx` (`PartyId`),
  KEY `fk_removedmonstercard_monstercard_idx` (`MonsterCardId`),
  CONSTRAINT `fk_removedmonstercard_party` FOREIGN KEY (`PartyId`) REFERENCES `party` (`Id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_removedmonstercard_monstercard` FOREIGN KEY (`MonsterCardId`) REFERENCES `monstercard` (`Id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `removedmonstercard`
--

LOCK TABLES `removedmonstercard` WRITE;
/*!40000 ALTER TABLE `removedmonstercard` DISABLE KEYS */;
/*!40000 ALTER TABLE `removedmonstercard` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `removedspellcard`
--

DROP TABLE IF EXISTS `removedspellcard`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `removedspellcard` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `Count` int(11) NOT NULL,
  `PartyId` int(11) NOT NULL,
  `SpellCardId` int(11) NOT NULL,
  PRIMARY KEY (`Id`),
  KEY `fk_removedspellcard_party_idx` (`PartyId`),
  KEY `fk_removedspellcard_spellcard_idx` (`SpellCardId`),
  CONSTRAINT `fk_removedspellcard_party` FOREIGN KEY (`PartyId`) REFERENCES `party` (`Id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_removedspellcard_spellcard` FOREIGN KEY (`SpellCardId`) REFERENCES `spellcard` (`Id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `removedspellcard`
--

LOCK TABLES `removedspellcard` WRITE;
/*!40000 ALTER TABLE `removedspellcard` DISABLE KEYS */;
/*!40000 ALTER TABLE `removedspellcard` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `removedvillaincard`
--

DROP TABLE IF EXISTS `removedvillaincard`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `removedvillaincard` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `Count` int(11) NOT NULL,
  `PartyId` int(11) NOT NULL,
  `VillainCardId` int(11) NOT NULL,
  PRIMARY KEY (`Id`),
  KEY `fk_removedvillaincard_party_idx` (`PartyId`),
  KEY `fk_removedvillaincard_villaincard_idx` (`VillainCardId`),
  CONSTRAINT `fk_removedvillaincard_party` FOREIGN KEY (`PartyId`) REFERENCES `party` (`Id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_removedvillaincard_villaincard` FOREIGN KEY (`VillainCardId`) REFERENCES `villaincard` (`Id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `removedvillaincard`
--

LOCK TABLES `removedvillaincard` WRITE;
/*!40000 ALTER TABLE `removedvillaincard` DISABLE KEYS */;
/*!40000 ALTER TABLE `removedvillaincard` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `removedweaponcard`
--

DROP TABLE IF EXISTS `removedweaponcard`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `removedweaponcard` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `Count` int(11) NOT NULL,
  `PartyId` int(11) NOT NULL,
  `WeaponCardId` int(11) NOT NULL,
  PRIMARY KEY (`Id`),
  KEY `fk_removedweaponcard_party_idx` (`PartyId`),
  KEY `fk_removedweaponcard_weaponcard_idx` (`WeaponCardId`),
  CONSTRAINT `fk_removedweaponcard_party` FOREIGN KEY (`PartyId`) REFERENCES `party` (`Id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_removedweaponcard_weaponcard` FOREIGN KEY (`WeaponCardId`) REFERENCES `weaponcard` (`Id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `removedweaponcard`
--

LOCK TABLES `removedweaponcard` WRITE;
/*!40000 ALTER TABLE `removedweaponcard` DISABLE KEYS */;
/*!40000 ALTER TABLE `removedweaponcard` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `spellcard`
--
...
CREATE TABLE `spellcard` (
  ...
  `AdventureDeckId` int(11) NOT NULL,
  PRIMARY KEY (`Id`),
  KEY `fk_spellcard_adventuredeck_idx` (`AdventureDeckId`),
  CONSTRAINT `fk_spellcard_adventuredeck` FOREIGN KEY (`AdventureDeckId`) REFERENCES `adventuredeck` (`Id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=122 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `spellcard`
--

LOCK TABLES `spellcard` WRITE;
/*!40000 ALTER TABLE `spellcard` DISABLE KEYS */;
INSERT INTO `spellcard` VALUES (63,'Acid Arrow',1),(64,'Aid',1),(65,'Arcane Armor',1),(66,'Augury',1),(67,'Charm Person',1),(68,'Cure',1),(69,'Detect Evil',1),(70,'Detect Magic',1),(71,'Find Traps',1),(72,'Force Missile',1),(73,'Glibness',1),(74,'Guidance',1),(75,'Holy Light',1),(76,'Inflict',1),(77,'Invisibility',1),(78,'Levitate',1),(79,'Lightning Touch',1),(80,'Mending',1),(81,'Mirror Image',1),(82,'Sanctuary',1),(83,'Sleep',1),(84,'Strength',1),(94,'Enfeeble',3),(95,'Fiery Weapon',3),(96,'Frost Ray',3),(97,'Scorching Ray',3),(98,'Speed',3),(101,'Consecration',4),(102,'Haste',4),(103,'Lighting Bolt',4),(104,'Toxic Cloud',4),(105,'Web',4),(108,'Incendiary',5),(109,'Major Cure',5),(110,'Scrying',5),(111,'Swipe',5),(115,'Mass Cure',6),(116,'Poison Blast',6),(117,'Restoration',6),(118,'Teleport',6);
/*!40000 ALTER TABLE `spellcard` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `villaincard`
--

DROP TABLE IF EXISTS `villaincard`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `villaincard` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `Name` varchar(100) NOT NULL,
  `AdventureDeckId` int(11) NOT NULL,
  PRIMARY KEY (`Id`),
  KEY `fk_villaincard_adventuredeck_idx` (`AdventureDeckId`),
  CONSTRAINT `fk_villaincard_adventuredeck` FOREIGN KEY (`AdventureDeckId`) REFERENCES `adventuredeck` (`Id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `villaincard`
--

LOCK TABLES `villaincard` WRITE;
/*!40000 ALTER TABLE `villaincard` DISABLE KEYS */;
/*!40000 ALTER TABLE `villaincard` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `weaponcard`
--

DROP TABLE IF EXISTS `weaponcard`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `weaponcard` (
  ...
  `AdventureDeckId` int(11) NOT NULL,
  PRIMARY KEY (`Id`),
  KEY `fk_weaponcard_adventuredeck_idx` (`AdventureDeckId`),
  CONSTRAINT `fk_weaponcard_adventuredeck` FOREIGN KEY (`AdventureDeckId`) REFERENCES `adventuredeck` (`Id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=67 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `weaponcard`
--

LOCK TABLES `weaponcard` WRITE;
/*!40000 ALTER TABLE `weaponcard` DISABLE KEYS */;
INSERT INTO `weaponcard` VALUES (1,'Bastard Sword',1),(2,'Battleaxe',1),(3,'Dagger',1),(4,'Dart',1),(5,'Flaming Mace +1',1),(6,'Glaive',1),(7,'Greataxe',1),(8,'Heavy Crossbow',1),(9,'Light Crossbow',1),(10,'Longbow',1),(11,'Longspear',1),(12,'Longsword',1),(13,'Longsword +1',1),(14,'Mace',1),(15,'Quarterstaff',1),(16,'Returning Throwing Axe +1',1),(17,'Scimitar',1),(18,'Shock Longbow +1',1),(19,'Short Sword',1),(20,'Shortbow',1),(21,'Sling',1),(22,'Spiked Chain',1),(23,'Starknife',1),(24,'Throwing Axe',1),(25,'Warhammer',1),(26,'Warhammer +1',1),(32,'Allying Dart +1',2),(33,'Deathbane Light Crossbow +1',2),(34,'Greatsword',2),(35,'Icy Longspear +1',2),(39,'Bastard Sword +1',3),(40,'Dagger +1',3),(41,'Dogslicer',3),(42,'Dogslicer +1',3),(43,'Longbow +1',3),(44,'Short Sword +1',3),(46,'Heavy Pick +1',4),(47,'Light Crossbow +1',4),(48,'Scythe +1',4),(49,'Sickle +1',4),(50,'War Razor +1',4),(51,'Impaler of Thorns',4),(53,'Frost Longbow +1',5),(54,'Longsword +2',5),(55,'Venomous Dagger +2',5),(56,'Vicious Trident +1',5),(60,'Giantbane Dagger +1',6),(61,'Greatclub +3',6),(62,'Runechill Hatchet +2',6),(63,'Shortspear +3',6);
/*!40000 ALTER TABLE `weaponcard` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2014-03-09 10:12:10
